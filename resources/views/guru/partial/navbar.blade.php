<nav
    ...
    <div
        ...
        <!-- Logo -->
        <a class="text-blueGray-600 text-sm uppercase font-bold mx-auto md:mx-0 p-4 px-0">
            TK Pertiwi Grojogan
        </a>
        ...
        <div class="md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1 rounded hidden"
            ...
            <ul class="md:flex-col md:min-w-full flex flex-col list-none">
                ...
                <li class="items-center">
                    <a href="{{ url('/siswa_guru') }}" class="text-xs uppercase py-3 font-bold block 
            {{ request()->is('siswa_guru') ? 'text-[#0090D4]' : 'text-blueGray-700 hover:text-[#0090D4]' }}">
                        <i
                            class="fas fa-graduation-cap mr-2 text-sm {{ request()->is('siswa_guru') ? 'text-[#0090D4]' : 'text-blueGray-300' }}"></i>
                        Data Siswa
                    </a>
                </li>
            ...
            {{ request()->is('profile') ? 'text-[#0090D4]' : 'text-blueGray-700 hover:text-[#0090D4]' }}">
                        <i
                            class="fas fa-newspaper mr-2 text-sm {{ request()->is('profile') ? 'text-[#0090D4]' : 'text-blueGray-300' }}"></i>
                        Profile
                    </a>
                </li>
            </ul>

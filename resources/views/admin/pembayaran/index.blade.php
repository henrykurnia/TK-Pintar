...
<head>
    ...
    <title>Pembayaran | Admin TK Pintar</title>
...
<body class="text-blueGray-700 antialiased">
    ...
    <div id="root">
        <div class="relative md:ml-64 bg-blueGray-50">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 items-center md:px-10 px-4 mt-4">
                <h1 class="text-black text-sm uppercase font-semibold lg:inline-block">Pembayaran</h1>
                ...
                <div class="flex flex-wrap items-center gap-2 mb-4">
                    ...
                    <div class="flex gap-2 ml-auto">
                        <div class="relative inline-block text-left">
                            ...
                            <div
                                class="origin-top-right absolute right-0 mt-2 w-40 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-10 hidden dropdown-filter-menu">
                                <div class="py-1" role="none">
                                    <a href="#" data-filter="all"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900 filter-option">
                                        <i class="fas fa-list-ul mr-2"></i> Semua
                                    </a>
                                    <a href="#" data-filter="A1"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900 filter-option">
                                        <i class="fas fa-chalkboard-teacher mr-2"></i> A1
                                    </a>
                                    <a href="#" data-filter="A2"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900 filter-option">
                                        <i class="fas fa-chalkboard-teacher mr-2"></i> A2
                                    </a>
                                    <a href="#" data-filter="B1"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900 filter-option">
                                        <i class="fas fa-chalkboard-teacher mr-2"></i> B1
                                    </a>
                                    <a href="#" data-filter="B2"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900 filter-option">
                    ...
                    <table class="min-w-full border border-gray-200 text-sm text-left text-gray-700">
                        <thead class="bg-[#0090D4] text-white uppercase text-center table-header-group">
                            <tr>
                                ...
                                <th class="px-2 py-1">Input Nilai</th>
                            </tr>
                        </thead>
    ...
    <tr class="border-b hover:bg-gray-50 mobile-stack" data-name="{{ strtolower($student->name) }}">
        <td class="px-2 py-1" data-label="No">{{ $loop->iteration }}</td>
        ...
        <td class="px-2 py-1" data-label="Input Pembayaran">
            <a href="{{ route('pembayaran.create', $student->id) }}"
               class="inline-flex items-center justify-center w-8 h-8 text-white bg-[#0090D4] rounded-full hover:bg-blue-700 transition">
    ...
    @empty
    <tr>
        <td colspan="7" class="px-4 py-2 text-center">Tidak ada data siswa</td>
    </tr>
    @endforelse
</tbody>
                    </table>

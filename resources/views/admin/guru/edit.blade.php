...
<head>
  ...
  <title>Edit Data Guru dan Staff | Admin TK Pintar</title>
  ...
  <div id="root">
    <div class="relative md:ml-64 bg-blueGray-50">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 items-center md:px-10 px-4 mt-4">
        <a class="text-black text-sm uppercase font-semibold lg:inline-block">Edit Guru/Staff</a>
      ...
      <div class="container mx-auto px-4 mt-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
          ...
          <!-- Form -->
          <form id="teacherForm" action="{{ route('guru.update', $teacher->id) }}" method="POST"
            ...
            <div>
              ...
              <input type="text" id="ttl" name="ttl" value="{{ $teacher->ttl }}"
                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring focus:border-blue-400"
            ...
            <!-- Alamat -->
            <div>
              <label for="address" class="block text-sm font-medium text-gray-700 mb-1">Alamat Tempat Tinggal</label>
            ...
            <!-- No.Telp -->
            <div>
              <label for="phone_number" class="block text-sm font-medium text-gray-700 mb-1">No.Telp</label>
            ...
            <div>
              ...
              <div class="mt-3">
                <img id="previewFoto"
                  src="{{ $teacher->photo_path ? asset($teacher->photo_path) : '' }}"
                  class="rounded-lg shadow"
                  style="max-width: 200px; height: auto; {{ $teacher->photo_path ? '' : 'display: none;' }}" />
              </div>
            </div>

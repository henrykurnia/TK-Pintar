...
<head>
  ...
  <title>Hasil Belajar | Admin TK Pintar</title>
  ...
  <div id="root">
    <div class="relative md:ml-64 bg-blueGray-50">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 items-center md:px-10 px-4 mt-4">
        <h1 class="text-black text-sm uppercase font-semibold lg:inline-block">Hasil Belajar</h1>
      ...
      <div class="container mx-auto px-4 mt-6">
        ...
        <div class="overflow-x-auto">
          ...
          <td class="px-2 py-1" data-label="Input Nilai">
            <a href="{{ route('hasil-belajar.input', $student->id) }}"
